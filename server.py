...
if __name__ == "__main__":
    ...
    if args.reload:
        # Hot-reload needs an import string, but this file is run as a script
        # (module __main__) and `server` now resolves to the server/ package, so
        # "server:app" no longer points here. Run the live app object instead;
        # reload is a dev convenience not used by the container.
        print("Warning: --reload is not supported when running server.py as a script; "
