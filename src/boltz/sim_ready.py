...
# ── MDP file generation (based on CHARMM-GUI equilibration protocol) ─────────

# Equilibration schedule: (step, BB, SC, dt, nsteps, pcoupl, gen_vel)
_EQ_SCHEDULE = [
    ("6.1", 4000, 2000, 0.001, 125000, False, True),
    ("6.2", 2000, 1000, 0.001, 125000, False, False),
    ("6.3", 1000,  500, 0.001, 125000, True,  False),
    ("6.4",  500,  200, 0.002, 250000, True,  False),
    ("6.5",  200,   50, 0.002, 250000, True,  False),
    ("6.6",   50,    0, 0.002, 250000, True,  False),
]
...
#
# Generated by PATCHR simulation-ready pipeline
# Based on CHARMM-GUI Membrane Builder equilibration protocol
# (Jo et al., J Comput Chem 2008; Wu et al., J Comput Chem 2014)
#
...
# Equilibration (6 steps with decreasing restraints)
...
for cnt in $(seq 1 10); do
    ...
    if [ $cnt -eq 1 ]; then
        pstep=$(printf "step6.%d_equilibration" 6)
